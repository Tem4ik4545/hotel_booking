...
SECRET_KEY = 'django-insecure--a)k4p43ionir=^_n*j+@&!bctx1y!06e1l%xqv^6+n8(-1zuk'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # Этот процессор добавляет request в контекст шаблонов
